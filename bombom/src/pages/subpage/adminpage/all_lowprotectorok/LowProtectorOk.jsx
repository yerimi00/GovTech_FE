...
const PageContainer = styled(ContainerCenter)`
  ...
  position: relative;
  background: linear-gradient(to bottom, #D7EFB1, white);
  padding-top: 30vh;
`;

const MenuButton = styled.button`
  background-color: ${({ isActive }) => (isActive ? '#BDD398' : '#D6EFAE')};
  border: none;
  border-radius: 3rem;
  display: flex;
  align-items: center;
                    ...
                    <MainDiv backgroundColor="white" borderRadius="35px">
                        <CustomRow width='100%' alignItems='center' justifyContent='flex-start'>
                            <Category width="40%" borderRadius="20px">
                                <CustomFont color='#6E5F3B' font='2rem' fontWeight='bold'>보호자 관리</CustomFont>
                            </Category>
                        </CustomRow>
                        ...
                        <CustomColumn width='100%' alignItems='center' justifyContent='center' gap='2rem'>
                            <CustomRow width='90%' alignItems='center' justifyContent='flex-start'>
                                <CustomFont color='#6E5F3B' font='1.3rem' fontWeight='bold'>저소득층 인증 수락</CustomFont>
                            </CustomRow>
                            <MenuContainer>
...
export default LowProtectorOkPage;
