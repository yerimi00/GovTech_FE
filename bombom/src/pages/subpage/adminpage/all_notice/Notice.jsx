...
const MenuButton = styled.button`
  background-color: ${({ isActive }) => (isActive ? '#C6C0AF' : '#E5DDC9')};
  border: none;
  border-radius: 3rem;
  display: flex;
  align-items: center;
...
const NoticePage = () => {
    ...
    const [activeButton, setActiveButton] = useState('답변 대기 중');
                    ...
                    <MainDiv backgroundColor="white" borderRadius="35px">
                        ...
                        <CustomColumn width='100%' alignItems='center' justifyContent='center' gap='2rem'>
                            <CustomRow width='90%' alignItems='center' justifyContent='flex-start'>
                                <CustomFont color='#6E5F3B' font='1.3rem' fontWeight='bold'>고객 센터 수락</CustomFont>
                            </CustomRow>
                            <MenuContainer>
                                <CustomRow width='100%' alignItems='center' justifyContent='space-between'>
                                    <MenuButton
                                        isActive={activeButton === '답변 대기 중'}
                                        onClick={() => handleMenuClick('답변 대기 중')}
                                    >
                                        <CustomFont color='#6E5F3B' font='0.8rem' fontWeight='bold'>답변 대기 중</CustomFont>
                                    </MenuButton>
                                    <MenuButton
                                        isActive={activeButton === '답변 완료'}
                                        onClick={() => handleMenuClick('답변 완료')}
                                    >
                                        <CustomFont color='#6E5F3B' font='0.8rem' fontWeight='bold'>답변 완료</CustomFont>
                                    </MenuButton>
                                </CustomRow>
                            </MenuContainer>
